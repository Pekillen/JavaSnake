...
public class GamePanel extends JPanel implements ActionListener {
	...
	Timer timer;
	Random random;
	int colorNumber = 3; //Change color
	boolean collisions;
	boolean grid = true;
	...
	// startGame method - set running to true and call timer
	...
	public void checkCollisions() {
		...
		if (!running) {
			...
			//IGNORE COLLISIONS AND GO ON THE OTHER SIDE
	...
	public class MyKeyAdapter extends KeyAdapter{
		...
		public void keyPressed(KeyEvent e) {
			switch(e.getKeyCode()) {		// Go in the set direction PROVIDED its not 180 degrees turn! 
